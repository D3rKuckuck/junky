...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/templates', ['templates/base.html']),
        ('share/' + package_name + '/templates', ['templates/index.html']),
        ('share/' + package_name + '/templates', ['templates/control_pc.html']),
        ('share/' + package_name + '/templates', ['templates/control_phone.html']),
        ('share/' + package_name + '/templates', ['templates/sensors.html']),
    ],
